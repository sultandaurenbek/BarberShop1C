...
Процедура ПриНачалеРаботыСистемы()
	...
	#Если ВебКлиент  Тогда
		...
		Параметры.Вставить("Высота",Высота);
		Параметры.Вставить("Ширина",Ширина);
		Если Veltrix_АдаптацияИнтерфейса.ЭтоМобильноеУстройство(Ширина,Высота) Тогда	
			ОткрытьФорму("Документ.Запись.Форма.ФормаМобильная",Параметры,,,,,,РежимОткрытияОкнаФормы.Независимый);
			//Возврат;
		Иначе
			ОткрытьФорму("Обработка.ЖурналЗаписей.Форма.Форма");
		КонецЕсли; 	
	#КонецЕсли
