...
Процедура ЗаполнитьДиаграммы(РезультатОтчета, ДанныеРасшифровкиКомпоновкиДанных)
	...
	ДиаграммаПоСотрудникам = РезультатОтчета.Рисунки[2].Объект;
	
	Если ДанныеРасшифровкиПоСотрудникам = "" Тогда
		ДанныеРасшифровкиПоСотрудникам = ПоместитьВоВременноеХранилище(ДанныеРасшифровкиКомпоновкиДанных, 
																   УникальныйИдентификатор);
	Иначе																		   
	 	ПоместитьВоВременноеХранилище(ДанныеРасшифровкиКомпоновкиДанных, ДанныеРасшифровкиПоСотрудникам);
	КонецЕсли;
